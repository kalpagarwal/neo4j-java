...
public class SellerId extends Seller {
    private ArrayList<String> values;
    private String operator;
    public SellerId(ArrayList<String> sellerId, String operator) {
    ...
    public Boolean filter(Node offering) {
        ...
        if(!this.values.isEmpty()) {
            String value = String.valueOf(offering.getProperty(GRAPH_NODE_PROPERTIES.Offering.sellerId, ""));
